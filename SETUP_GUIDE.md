...
Windows and macOS can install dependencies, typecheck, test, and run the Expo development server. This project uses Expo Go and does not require a local native build.
...
On a Mac with the iOS Simulator and Expo Go installed:
